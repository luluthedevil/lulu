$(document).ready(function(){
    ...
    //getting the about section texts
    ...
    //gettinh the skills section texts
    ...
    const projectsData = [
        {
            ...
            "proj-title-connect-4": "Connect four game",
            "proj-txt-connect-4": "Connect four game with python",
            "proj-title-snake": "Snake game",
            "proj-txt-snake": "Snake game with python",
            ...
            "proj-title-freeway": "Freeway game",
            "proj-txt-freeway": "A freeway (cross the street) game made with javascript",
        },
        {
            "lang": "pt",
            "title": "Meus projetos",
            ...
            "proj-title-connect-4": "Jogo conecte quatro",
            "proj-txt-connect-4": "Jogo conecte quatro com python",
            "proj-title-snake": "Jogo da cobrinha",
            "proj-txt-snake": "Jogo da cobrinha python",
            ...
            "proj-title-freeway": "Jogo atravesse a rua",
            "proj-txt-freeway": "Um jogo de atravessar a rua feito com javascript",
        },
        {
            "lang": "fr",
            "title": "Mes projets",
            ...
            "proj-title-connect-4": "Connectez quatre jeux",
            "proj-txt-connect-4": "Connectez quatre jeux avec python",

            "proj-title-snake": "Jeu de serpent",
            "proj-txt-snake": "Jeu de serpent avec python",
            ...
            "proj-title-freeway": "Jeu d'autoroute",
            "proj-txt-freeway": "Un jeu d'autoroute (traverser la rue) fait avec javascript",
        },
    ];
    ...
    const projTitleConnect4 = document.getElementById('proj-title-connect-4');
    const projTxtConnect4 = document.getElementById('proj-txt-connect-4');

    const projTitleSnake = document.getElementById('proj-title-snake');
    const projTxtSnake = document.getElementById('proj-txt-snake');
    ...
    const projTitleFreeway = document.getElementById('proj-title-freeway');
    const projTxtFreeway = document.getElementById('proj-txt-freeway');
        ...
        el.addEventListener('click', () => {
            ...
            for(let i=0; i < data.length; i++) {
                if(data[i].lang == attr) {
                    ...
                    projTitleConnect4.textContent = projectsData[i]["proj-title-connect-4"];
                    projTxtConnect4.textContent = projectsData[i]["proj-txt-connect-4"];

                    projTitleSnake.textContent = projectsData[i]["proj-title-snake"];
                    projTxtSnake.textContent = projectsData[i]["proj-txt-snake"];
                    ...
                    projTitleFreeway.textContent = projectsData[i]["proj-title-freeway"];
                    projTxtFreeway.textContent = projectsData[i]["proj-txt-freeway"];
